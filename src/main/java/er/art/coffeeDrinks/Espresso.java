...
public class Espresso implements CoffeDrinks {
    ...
    public Espresso (CoffeeMachine coffeeMachine, int size) {
        this.size = size;
    ...
    public void calkOfIngredients () {
        water = (int) Math.round ( size * 0.7d );
        coffee = (int) Math.round ( size * 0.3d );
