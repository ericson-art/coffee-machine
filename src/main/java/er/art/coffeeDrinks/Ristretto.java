...
public class Ristretto implements CoffeDrinks {
    ...
    public Ristretto (CoffeeMachine coffeeMachine, int size) {
    ...
    public void calkOfIngredients () {
        ...
        water = (int) Math.round ( size * 0.5d );
        coffee = (int) Math.round ( size * 0.5d );
